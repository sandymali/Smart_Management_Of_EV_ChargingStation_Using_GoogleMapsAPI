      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay="200">
            ...
            <form action="SearchSlot.jsp" method="post" role="form">
             
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="search" placeholder="Search charging points" required>
              </div>
            
             <br><br>
             
              <div class="text-center"><button type="submit">Search</button>&nbsp;&nbsp;&nbsp;<br><br>
              </div>
            </form>
